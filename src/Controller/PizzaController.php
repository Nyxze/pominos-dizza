...
class PizzaController extends AbstractController
{
    ...
    public function index(PizzaRepository $pizzaRepository, ToppingRepository $toppingRepository): Response
    {
    ...
    public function new(Request $request, PizzaRepository $pizzaRepository, ToppingRepository $toppingRepository): Response
    {
        $pizza = new Pizza();
