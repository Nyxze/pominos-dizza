 ...
 */
final class Version20220319172121 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE topping ADD qt INT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE topping DROP qt, CHANGE name name VARCHAR(128) NOT NULL COLLATE `utf8mb4_unicode_ci`');
    }
}
